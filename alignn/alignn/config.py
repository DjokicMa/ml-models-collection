...
class TrainingConfig(BaseSettings):
    ...
    # Enhanced training features (for trainV2.py and train_alignnV2.py)
    lmdb_path: Optional[str] = None  # Path to existing LMDB cache
    report_mae: bool = False  # Report MAE at each epoch
    normalize_loss: bool = False  # Normalize loss by dataset size
    skip_cache_verification: bool = False  # Skip LMDB cache verification
    cache_metadata_path: Optional[str] = None  # Path to cache metadata file
